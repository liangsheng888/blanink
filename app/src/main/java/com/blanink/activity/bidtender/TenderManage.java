 ...
 * 招标管理
 */
public class TenderManage extends AppCompatActivity {
    ...
    private UpLoadListView lv_tender;
    ...
    private void initView() {
        ...
        lv_tender = ((UpLoadListView) findViewById(R.id.lv_tender));
    ...
    private void initData() {
        ...
        //
        lv_tender.setOnRefreshListener(new UpLoadListView.OnRefreshListener() {
