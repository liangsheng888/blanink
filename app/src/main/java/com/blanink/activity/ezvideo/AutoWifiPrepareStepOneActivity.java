...
import com.blanink.activity.ezvideo.widget.BoldSpan;
...
public class AutoWifiPrepareStepOneActivity extends RootActivity implements OnClickListener {
    ...
    private void initTitleBar() {
        TextView mTitleBar = (TextView) findViewById(R.id.tv_title);
        TextView last = (TextView) findViewById(R.id.last);
        mTitleBar.setText(R.string.auto_wifi_step_one_title);
