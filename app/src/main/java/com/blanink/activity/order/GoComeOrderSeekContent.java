 ...
 * 去单 来单 搜索
 */
public class GoComeOrderSeekContent extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        Log.e("GoComeOrderSeekContent", NetUrlUtils.NET_URL + "order/listJson_coming?userId=" + sp.getString("USER_ID", null) + "&flag=0&" +
        ...
        x.http().post(rp, new Callback.CacheCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                Log.e("GoComeOrderSeekContent", result);
                Gson gson = new Gson();
                ComeOder order = gson.fromJson(result, ComeOder.class);
                Log.e("GoComeOrderSeekContent", "解析：" + order.toString());
