 ...
 */
public class ComeOrderContinueAddProductActivity extends Activity {
        ...
        btSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(orderNote)){
                    Toast.makeText(ComeOrderContinueAddProductActivity.this, "请填写备注", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(urls)){
                    Toast.makeText(ComeOrderContinueAddProductActivity.this, "请上传图片", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void saveOrder() {
        ...
        RequestParams rp = new RequestParams(NetUrlUtils.NET_URL + "order/saveOrderProduct");

        rp.addBodyParameter("userId", sp.getString("USER_ID", null));
        rp.addBodyParameter("orderProductList[0].bCompany.id", sp.getString("COMPANY_ID", null));//乙方公司id
        rp.addBodyParameter("orderProductList[0].aCompany.id", aCompanyId);//甲方公司id
        rp.addBodyParameter("id",orderId);
       // rp.addBodyParameter("bOrderNumber", productNumber);//生产编号
        ...
        Log.e("@@@@",NetUrlUtils.NET_URL + "order/saveOrderProduct?" +
                     "orderProductList[0].bCompany.id="+sp.getString("COMPANY_ID", null)+
                        "&id="+orderId+
                        "&remarks="+orderNote+
    ...
    public void showNotifyTwo(String tilte, String btnLeft, String btnRight) {
        ...
        window.findViewById(R.id.tv_seek).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendBroadcast(it);
                Intent intent = new Intent(ComeOrderContinueAddProductActivity.this, MainActivity.class);
