    ...
    private void initData() {
        ...
        workStepQueueLvTaskQueue.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TaskResponseQueue.this, TaskResponseListPlanedTask.class);
    ...
    public void loadDatafromServer() {
        ...
        x.http().post(requestParams, new Callback.CacheCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                Log.e("TaskResponseQueue", result);
                Gson gson = new Gson();
                ProcessFeedback pf = gson.fromJson(result, ProcessFeedback.class);
                if (pf.result.size() == 0) {
                    rlNotData.setVisibility(View.VISIBLE);
                }
                Log.e("TaskResponseQueue", pf.toString());
                processFeedbackList.addAll(pf.result);
                if (commonAdapter == null) {
                    commonAdapter = new CommonAdapter<ProcessFeedback.Result>(TaskResponseQueue.this, processFeedbackList, R.layout.item_task_response_queue) {
                        @Override
