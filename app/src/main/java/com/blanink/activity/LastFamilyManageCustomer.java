...
public class LastFamilyManageCustomer extends AppCompatActivity implements Animator.AnimatorListener {
        ...
        lv_customer_queue.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position > 0 && position < customers.size() + 1) {
                    ...
                    String companyId = customers.get(position - 1).getId();
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Log.e("Last", " getView 上家管理 customer:" + customer.getCompanyA().toString());
            viewHolder.tv_scope.setText(customer.getCompanyA().getScope());
            viewHolder.tv_master.setText(customer.getCompanyA().getMaster());
            viewHolder.tv_name.setText(customer.getCompanyA().getName());
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dX < 8 && dY > 8 && !mIsTitleHide && !down) {
                    ObjectAnimator animator1 = ObjectAnimator.ofFloat(ll_title, "translationY", 0.0F, -0.0f);
