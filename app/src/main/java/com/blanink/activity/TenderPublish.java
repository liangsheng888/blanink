...
public class TenderPublish extends AppCompatActivity {
    ...
    private void initView() {
        last = ((ImageView) findViewById(R.id.bid_apply_iv_last));
    ...
    private void initData() {
        ...
        //
        ArrayList<Integer> drawableLists=new ArrayList<Integer>();
        // 往集合中添加图片
        ...
        x.http().post(requestParams, new Callback.CacheCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if("00000".equals(response.getErrorCode())){
                    AlertDialog alertDialog=new AlertDialog.Builder(TenderPublish.this).create();
                    alertDialog.setTitle("提示");
                    alertDialog.setMessage("发布成功");
                    alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "查看我发布的招标", new DialogInterface.OnClickListener() {
                        @Override
                    ...
                    alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "继续发布", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                        }
