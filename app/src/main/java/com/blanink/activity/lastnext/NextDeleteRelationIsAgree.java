...
public class NextDeleteRelationIsAgree extends AppCompatActivity {
    ...
    private void getDataFromServer() {
        ...
        x.http().post(rp, new Callback.CacheCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                tvCompanyXinYu.setText(new DecimalFormat("0.0").format((notifyOffice.getResult().getCompanyB().getReviewSelf()+notifyOffice.getResult().getCompanyB().getReviewOthers())/2.0));
