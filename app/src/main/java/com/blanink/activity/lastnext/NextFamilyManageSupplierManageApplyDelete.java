    ...
    private void initData() {
        ...
        if (info != null) {
          ...
          tv_company_other_remark.setText(info.result.reviewOthers + "");
            ...
            tv_company_honest.setText((info.result.reviewOthers + info.result.reviewSelf ) / 2.0+"");
        }
    }
    ...
    public void getData() {
        ...
        x.http().post(rp, new Callback.CacheCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                tv_company_remark.setText(info.result.reviewSelf + "");
                tv_company_other_remark.setText(info.result.reviewOthers + "");
                tv_company_honest.setText((info.result.reviewSelf  + info.result.reviewOthers)/ 2.0+"");
            }
