 ...
 */
public class LastFamilyManageCustomerSupplierInvite extends AppCompatActivity {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.bt_agree:
                //同意
                DialogLoadUtils.showDialogLoad(LastFamilyManageCustomerSupplierInvite.this);
                agreeApply();
                break;
            case R.id.bt_refuse:
                //拒绝
    ...
    //拒绝
    private void reject() {
        RequestParams rp = new RequestParams(NetUrlUtils.NET_URL + "partner/customerRemoveNo");
        rp.addBodyParameter("currentUser.id", sp.getString("USER_ID", null));
        rp.addBodyParameter("companyA.id", sp.getString("COMPANY_ID", null));
        rp.addBodyParameter("companyB.id", notifyOffice.getResult().getCompanyB().getId());
    ...
    public void agreeApply() {
        ...
        RequestParams rp = new RequestParams(NetUrlUtils.NET_URL + "customer/customerAgree");
        rp.addBodyParameter("currentUser.id", sp.getString("USER_ID", null));
        rp.addBodyParameter("companyA.id", sp.getString("COMPANY_ID", null));
        rp.addBodyParameter("companyB.id",notifyOffice.getResult().getCompanyB().getId());
        rp.addBodyParameter("isApply","0");
